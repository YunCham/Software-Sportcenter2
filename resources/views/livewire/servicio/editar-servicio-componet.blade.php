                    ...
                    <form wire:submit.prevent='updateServicio'>
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select class="form-control border border-2 p-2" name="tservicio_id" id=""
                                    wire:model="tservicio_id">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input wire:model="duracion" name="duracion" type="time"
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input wire:model="precio" type="number" class="form-control border border-2 p-2">
                                @error('precio')
                                    <p class='text-danger inputerror'>{{ $message }} </p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <label class="form-label">Estdo</label>
