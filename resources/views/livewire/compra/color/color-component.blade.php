            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    ...
                    <div class="me-3 my-3 text-end">
                        <a class="btn bg-gradient-dark mb-0" href="{{ route('color-registro') }}"><i
                                ...
                                @foreach ($colors as $color)
                                    <tr>
                                      ...
                                      <td class="align-middle">
                                          <a href="{{ route('color-editar', ['color_id' => $color->id]) }}"
                                      ...
                                      <td class="align-middle">
                                          <a href="#" class="text-secondary font-weight-bold text-xs"
                                                ...
                                                data-bs-toggle="modal" data-bs-target="#modal-notification-{{ $color->id }}">
                                                Eliminar
                                          </a>
                                            <div class="modal fade" id="modal-notification-{{ $color->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button"
                                                                ...
                                                                wire:click="deleteMarca({{ $color->id }})">Eliminar
                                                                Marca</button>
                                                            <button type="button"
